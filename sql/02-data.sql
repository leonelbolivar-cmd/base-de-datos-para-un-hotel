...
INSERT INTO habitaciones(numero_habitacion, tipo_habitacion, capacidad_personas, precio_base_noche, estado_habitacion, caracteristicas_adicionales) VALUES
  ('101', 'Sencilla', 1, 120.00, 'Disponible', '{"tv": true, "frigobar": true, "cama_king": true}'),
  ('102', 'Doble', 2, 200.00, 'Disponible',' {"tv_4k": true, "frigobar": true, "microondas": true}'),
  ('103', 'Matrimonial', 2, 250.00, 'Ocupada','{"jacuzzi": true, "vista": "mar", "frigobar": true}'),
  ('104', 'Familiar', 4, 350.00, 'Disponible', '{"tv": true, "frigobar": true, "cama_king": true}'),
  ('105', 'Suite', 2, 500.00, 'En Mantenimiento', '{"jacuzzi": true, "vista": "mar", "frigobar": true}'),
  ('205B', 'Suite Doble', 4, 450.00, 'Ocupada', '{"jacuzzi": true, "vista": "mar", "frigobar": true}');
...
INSERT INTO movimientos_almacen(id_producto, id_empleado, cantidad, tipo_movimiento, fecha_movimiento) VALUES
  ...
  (14, 4, 50, 'Entrada', CURRENT_TIMESTAMP);
...
INSERT INTO guarderia_registros(id_registro_guarderia, nombre_nino, hora_ingreso, hora_salida, id_reserva, id_empleado) VALUES
  (1, 'Mateo Benavides', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '2 hours', 101, 5), 
  (2, 'Valentina Paz',   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '3 hours', 102, 5),       
  (3, 'Thiago Sosa',     CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '1 hour',  103, 3), 
  (4, 'Sofía Méndez',    CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '4 hours', 104, 2),        
  (5, 'Lucas Torres',    CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '2 hours', 105, 1); 
